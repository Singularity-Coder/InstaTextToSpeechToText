package com.singularitycoder.texttospeech;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkForPermissions(Callable<Void> work) {
    ...
    private void clickListeners() {
        btnTextToSpeech.setOnClickListener(v -> checkForPermissions(() -> startTextToSpeech()));
        ...
        btnSaveToAudio.setOnClickListener(view -> {
            checkForPermissions(() -> startTextToSpeech());
